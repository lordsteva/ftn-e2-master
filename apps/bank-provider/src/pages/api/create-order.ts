...
export default async function handler(req, res) {
  ...
  const payment: paymentIntent = {
    ...
    success_url: `https://192.168.43.234:1235/payment/capture/${orderId}/`,
    failed_url: `https://192.168.43.234:1235/payment/capture/${orderId}/`,
    error_url: `https://192.168.43.234:1235/payment/capture/${orderId}/`,
  };
