    ...
    <div>
      ...
      <ProductTile
        product={{
          ...
          description:
            'Intel Core i3-5005U, Intel HD Graphics 5500, 1000GB HDD, 6GB DDR3, 1600 MHz, 2.22 kg (4.9 lbs), 15.6”, HD (1366 x 768), TN ',
          price: 550,
          onClick: undefined,
          buttonTitle: 'Details',
          qty: 5,
      ...
      <Input
        errorText="This is a error text ajajjajajaajaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
        id="input"
        type="text"
        labelText="FirstName"
      />
      ...
      <Table
        headerData={['Name', 'Email', 'Date', 'Action']}
        bodyData={[
          {
